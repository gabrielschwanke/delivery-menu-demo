document.addEventListener("DOMContentLoaded", () => {
  const CONFIG = {
    storeName: "Sabor Express",
    slogan: "Sabor que conquista!",
    whatsappNumber: "5500000000000", // coloque aqui o número real do cliente, com DDI + DDD
    whatsappDisplay: "(00) 00000-0000",
    businessHours: "De segunda a segunda, das 19h30 às 23h30.",
    address: "Rua Exemplo, 123, Bairro Modelo, Sua Cidade",
...
},
{
  ...
  destaque: false,
    ...
    
    {
      ...
      nome: "Iscas Fritas",
      descricao:
        "O pedido favorito da casa! Iscas suculentas de carne de rês selecionada, preparadas na chapa e cobertas com uma camada generosa de muçarela derretida. Acompanha batatas fritas crocantes por fora e macias por dentro, finalizadas com o nosso exclusivo molho especial da casa.",
      preco: 60,
