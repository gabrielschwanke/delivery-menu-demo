# Sabor Express — Delivery Menu Template
...
> This is a **demo/template version** built from a real client project, with all
> business-specific data (name, contact, address, branding) replaced with sample content.
> Used to showcase this delivery menu solution to prospective clients.

---

## Live Demo

[View Online](#) <!-- atualize com o novo link do deploy -->
...
**Sabor Express** is a front-end project built to simulate a complete food delivery experience.
